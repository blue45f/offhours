...
import { useCorporateProfile } from '../../domains/corporate/api'
import { useCreateReservation, useCreateRecurring } from '../../domains/reservations/api'
import { defaultHeadcount } from '../../domains/reservations/headcount'
import { useQuote } from '../../domains/spaces/api'
