/* eslint-disable react-hooks/set-state-in-effect, react-hooks/immutability, react-compiler/react-compiler, jsx-a11y/no-static-element-interactions, jsx-a11y/no-noninteractive-element-interactions -- 벤더링된 단일 파일 위젯(upstream searchdesk): 디바운스 검색·콤보박스 동작은 의도적. */
/**
