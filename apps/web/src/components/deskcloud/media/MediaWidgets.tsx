/* eslint-disable react-hooks/set-state-in-effect, jsx-a11y/no-interactive-element-to-noninteractive-role, react-refresh/only-export-components -- 벤더링된 단일 파일 위젯(upstream mediadesk): 드롭존·갤러리 role·부수 export 는 의도적. */
/**
